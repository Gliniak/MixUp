...
public class MySongsFragment extends Fragment {
    ...
    public void onViewCreated(View view, @Nullable Bundle savedInstanceState)
    {
        ...
        songs_view = getView().findViewById(R.id.mysongs_elements_view);
    ...
    public void LoadSongsData()
    {
        ...
        Query myLibSongsQuery = FirebaseQueries.GetUploadedSongs(mDatabase, mAuth.getUid());
